...
dblist = []
dbfile = file("target_coordinates.txt", "r")
# dbfile should contain 3 columns (no header), which are name, right ascension
# in decimal degrees, and declination in decimal degrees.
for line in dbfile:
...
# Make sure your start and end dates match the range over which you plan to be
# observing.
...
window_constraint = 2.0 # minimum length in hours of "good" window
